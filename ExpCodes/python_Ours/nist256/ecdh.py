...
from nist256 import big
from nist256 import curve
from nist256.ecp import ECp
from nist256.ecp import generator
from nist256.ecp import mul
...
def ECP_SvDSA(P, F, C, D):
    ...
    if c == 0 or c >= r or d == 0 or d >= r:
        return False
    d = big.invmodp(d, r)  # s
    f = big.modmul(f, d, r) # h(x) w
    h2 = big.modmul(c, d, r) # r w
